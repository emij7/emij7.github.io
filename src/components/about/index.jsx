...
const ItemLayout = ({ children, className }) => {
  return (
    <div
      className={clsx(
        "custom-bg p-8 rounded-xl flex items-center justify-center space-y-4",
        className
      )}
    >
      {children}
  ...
  return (
    <div className="py-20 w-full">
      <div className="grid grid-cols-12 gap-8 w-full">
        <ItemLayout
          className={
            "col-span-8 row-span-2 flex-col items-start"
          }
        >
        ...
        <ItemLayout
          className={"col-span-4 text-accent !p-0"}
        >
          <img
        ...
        <ItemLayout
          className={"col-span-8 text-accent !p-0"}
        >
          <img
            className="w-full h-auto"
